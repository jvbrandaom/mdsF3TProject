...
/**
 * This is the item provider adapter for a {@link Academia.ATypedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ATypedElementItemProvider
	 ...
	 * @generated
	 */
	public ATypedElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((ATypedElement)object).getTypeName();
		return label == null || label.length() == 0 ?
			getString("_UI_ATypedElement_type") :
			getString("_UI_ATypedElement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ATypedElement.class)) {
