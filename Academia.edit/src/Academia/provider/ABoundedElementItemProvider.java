...
/**
 * This is the item provider adapter for a {@link Academia.ABoundedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ABoundedElementItemProvider
	 ...
	 * @generated
	 */
	public ABoundedElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((ABoundedElement)object).getLowerBound();
		return label == null || label.length() == 0 ?
			getString("_UI_ABoundedElement_type") :
			getString("_UI_ABoundedElement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ABoundedElement.class)) {
