 ...
 * @generated
 */
public class AOperation6EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public AOperation6EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new Academia.diagram.edit.policies.AOperation6ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new Academia.diagram.edit.policies.AOperation6CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Academia.diagram.edit.parts.AOperationName6EditPart) {
			((Academia.diagram.edit.parts.AOperationName6EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureOperationNameLabel());
			return true;
		}
		if (childEditPart instanceof Academia.diagram.edit.parts.WrappingLabel6EditPart) {
			((Academia.diagram.edit.parts.WrappingLabel6EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureOperationOpenParenthesesLabel());
			return true;
		}
		if (childEditPart instanceof Academia.diagram.edit.parts.AOperationTypeName6EditPart) {
			((Academia.diagram.edit.parts.AOperationTypeName6EditPart) childEditPart)
					.setLabel(getPrimaryShape()
