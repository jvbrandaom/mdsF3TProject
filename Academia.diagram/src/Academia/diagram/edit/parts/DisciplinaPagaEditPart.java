 ...
 * @generated
 */
public class DisciplinaPagaEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DisciplinaPagaEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new Academia.diagram.edit.policies.DisciplinaPagaItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Academia.diagram.edit.parts.DisciplinaPagaStereoEditPart) {
			((Academia.diagram.edit.parts.DisciplinaPagaStereoEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureFeatureStereoLabel());
			return true;
		}
		if (childEditPart instanceof Academia.diagram.edit.parts.DisciplinaPagaNameEditPart) {
			((Academia.diagram.edit.parts.DisciplinaPagaNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureFeatureNameLabel());
			return true;
		}
		if (childEditPart instanceof Academia.diagram.edit.parts.DisciplinaPagaAttributesEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureFeaturePropertiesCompartment();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((Academia.diagram.edit.parts.DisciplinaPagaAttributesEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof Academia.diagram.edit.parts.DisciplinaPagaOperationsEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureFeatureOperationsCompartment();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((Academia.diagram.edit.parts.DisciplinaPagaOperationsEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof Academia.diagram.edit.parts.DisciplinaPagaAttributesEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureFeaturePropertiesCompartment();
			pane.remove(((Academia.diagram.edit.parts.DisciplinaPagaAttributesEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof Academia.diagram.edit.parts.DisciplinaPagaOperationsEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureFeatureOperationsCompartment();
			pane.remove(((Academia.diagram.edit.parts.DisciplinaPagaOperationsEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof Academia.diagram.edit.parts.DisciplinaPagaAttributesEditPart) {
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == Academia.diagram.providers.AcademiaElementTypes.AAttribute_3019) {
				return getChildBySemanticHint(Academia.diagram.part.AcademiaVisualIDRegistry
