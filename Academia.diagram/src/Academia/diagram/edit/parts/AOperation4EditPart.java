 ...
 * @generated
 */
public class AOperation4EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public AOperation4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new Academia.diagram.edit.policies.AOperation4ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new Academia.diagram.edit.policies.AOperation4CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Academia.diagram.edit.parts.AOperationName4EditPart) {
			((Academia.diagram.edit.parts.AOperationName4EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureOperationNameLabel());
			return true;
		}
		if (childEditPart instanceof Academia.diagram.edit.parts.WrappingLabel4EditPart) {
			((Academia.diagram.edit.parts.WrappingLabel4EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureOperationOpenParenthesesLabel());
			return true;
		}
		if (childEditPart instanceof Academia.diagram.edit.parts.AOperationTypeName4EditPart) {
			((Academia.diagram.edit.parts.AOperationTypeName4EditPart) childEditPart)
					.setLabel(getPrimaryShape()
