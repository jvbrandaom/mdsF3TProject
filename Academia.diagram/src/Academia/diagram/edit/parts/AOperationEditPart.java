...
import Academia.diagram.edit.policies.AOperationCanonicalEditPolicy;
import Academia.diagram.edit.policies.AOperationItemSemanticEditPolicy;
import Academia.diagram.edit.policies.AcademiaTextSelectionEditPolicy;
import Academia.diagram.part.AcademiaVisualIDRegistry;
 ...
 * @generated
 */
public class AOperationEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new Academia.diagram.edit.policies.AOperationItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new Academia.diagram.edit.policies.AOperationCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Academia.diagram.edit.parts.AOperationNameEditPart) {
			((Academia.diagram.edit.parts.AOperationNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureOperationNameLabel());
			return true;
		}
		if (childEditPart instanceof Academia.diagram.edit.parts.WrappingLabelEditPart) {
			((Academia.diagram.edit.parts.WrappingLabelEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureOperationOpenParenthesesLabel());
			return true;
		}
		if (childEditPart instanceof Academia.diagram.edit.parts.AOperationTypeNameEditPart) {
			((Academia.diagram.edit.parts.AOperationTypeNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
	...
	protected void addChildVisual(EditPart childEditPart, int index) {
		...
		super.addChildVisual(childEditPart, 2); // Changed from:
												// super.addChildVisual(childEditPart,
												// -1);
	}
