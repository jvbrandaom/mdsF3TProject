 ...
 * @generated
 */
public class AOperation7EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public AOperation7EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new Academia.diagram.edit.policies.AOperation7ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new Academia.diagram.edit.policies.AOperation7CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Academia.diagram.edit.parts.AOperationName7EditPart) {
			((Academia.diagram.edit.parts.AOperationName7EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureOperationNameLabel());
			return true;
		}
		if (childEditPart instanceof Academia.diagram.edit.parts.WrappingLabel7EditPart) {
			((Academia.diagram.edit.parts.WrappingLabel7EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureOperationOpenParenthesesLabel());
			return true;
		}
		if (childEditPart instanceof Academia.diagram.edit.parts.AOperationTypeName7EditPart) {
			((Academia.diagram.edit.parts.AOperationTypeName7EditPart) childEditPart)
					.setLabel(getPrimaryShape()
