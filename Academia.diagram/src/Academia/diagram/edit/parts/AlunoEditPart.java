 ...
 * @generated
 */
public class AlunoEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public AlunoEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new Academia.diagram.edit.policies.AlunoItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Academia.diagram.edit.parts.AlunoStereoEditPart) {
			((Academia.diagram.edit.parts.AlunoStereoEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureFeatureStereoLabel());
			return true;
		}
		if (childEditPart instanceof Academia.diagram.edit.parts.AlunoNameEditPart) {
			((Academia.diagram.edit.parts.AlunoNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureFeatureNameLabel());
			return true;
		}
		if (childEditPart instanceof Academia.diagram.edit.parts.AlunoAttributesEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureFeaturePropertiesCompartment();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((Academia.diagram.edit.parts.AlunoAttributesEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof Academia.diagram.edit.parts.AlunoOperationsEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureFeatureOperationsCompartment();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((Academia.diagram.edit.parts.AlunoOperationsEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof Academia.diagram.edit.parts.AlunoAttributesEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureFeaturePropertiesCompartment();
			pane.remove(((Academia.diagram.edit.parts.AlunoAttributesEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof Academia.diagram.edit.parts.AlunoOperationsEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureFeatureOperationsCompartment();
			pane.remove(((Academia.diagram.edit.parts.AlunoOperationsEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof Academia.diagram.edit.parts.AlunoAttributesEditPart) {
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == Academia.diagram.providers.AcademiaElementTypes.AAttribute_3004) {
				return getChildBySemanticHint(Academia.diagram.part.AcademiaVisualIDRegistry
