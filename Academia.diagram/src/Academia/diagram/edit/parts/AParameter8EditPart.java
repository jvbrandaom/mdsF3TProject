 ...
 * @generated
 */
public class AParameter8EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public AParameter8EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new Academia.diagram.edit.policies.AParameter8ItemSemanticEditPolicy());
		installEditPolicy(
				EditPolicy.PRIMARY_DRAG_ROLE,
				new Academia.diagram.edit.policies.AcademiaTextNonResizableEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = Academia.diagram.providers.AcademiaParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					Academia.diagram.edit.parts.AcademiaEditPartFactory
	...
	protected IFigure createFigurePrim() {
		return new AParameterFigure();
	}

	/**
	 * @generated
	 */
	public class AParameterFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AParameterFigure() {
			this.setText("");
