 ...
 * @generated
 */
public class CursoEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public CursoEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new Academia.diagram.edit.policies.CursoItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Academia.diagram.edit.parts.CursoStereoEditPart) {
			((Academia.diagram.edit.parts.CursoStereoEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureFeatureStereoLabel());
			return true;
		}
		if (childEditPart instanceof Academia.diagram.edit.parts.CursoNameEditPart) {
			((Academia.diagram.edit.parts.CursoNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureFeatureNameLabel());
			return true;
		}
		if (childEditPart instanceof Academia.diagram.edit.parts.CursoAttributesEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureFeaturePropertiesCompartment();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((Academia.diagram.edit.parts.CursoAttributesEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof Academia.diagram.edit.parts.CursoOperationsEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureFeatureOperationsCompartment();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((Academia.diagram.edit.parts.CursoOperationsEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof Academia.diagram.edit.parts.CursoAttributesEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureFeaturePropertiesCompartment();
			pane.remove(((Academia.diagram.edit.parts.CursoAttributesEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof Academia.diagram.edit.parts.CursoOperationsEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureFeatureOperationsCompartment();
			pane.remove(((Academia.diagram.edit.parts.CursoOperationsEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof Academia.diagram.edit.parts.CursoAttributesEditPart) {
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == Academia.diagram.providers.AcademiaElementTypes.AAttribute_3007) {
				return getChildBySemanticHint(Academia.diagram.part.AcademiaVisualIDRegistry
