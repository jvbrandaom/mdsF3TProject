 ...
 * @generated
 */
public class DepartamentoEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DepartamentoEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new Academia.diagram.edit.policies.DepartamentoItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Academia.diagram.edit.parts.DepartamentoStereoEditPart) {
			((Academia.diagram.edit.parts.DepartamentoStereoEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureFeatureStereoLabel());
			return true;
		}
		if (childEditPart instanceof Academia.diagram.edit.parts.DepartamentoNameEditPart) {
			((Academia.diagram.edit.parts.DepartamentoNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureFeatureNameLabel());
			return true;
		}
		if (childEditPart instanceof Academia.diagram.edit.parts.DepartamentoAttributesEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureFeaturePropertiesCompartment();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((Academia.diagram.edit.parts.DepartamentoAttributesEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof Academia.diagram.edit.parts.DepartamentoOperationsEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureFeatureOperationsCompartment();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((Academia.diagram.edit.parts.DepartamentoOperationsEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof Academia.diagram.edit.parts.DepartamentoAttributesEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureFeaturePropertiesCompartment();
			pane.remove(((Academia.diagram.edit.parts.DepartamentoAttributesEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof Academia.diagram.edit.parts.DepartamentoOperationsEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureFeatureOperationsCompartment();
			pane.remove(((Academia.diagram.edit.parts.DepartamentoOperationsEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof Academia.diagram.edit.parts.DepartamentoAttributesEditPart) {
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == Academia.diagram.providers.AcademiaElementTypes.AAttribute_3010) {
				return getChildBySemanticHint(Academia.diagram.part.AcademiaVisualIDRegistry
