 ...
 * @generated
 */
public class AcademiaDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public AcademiaDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof Academia.diagram.navigator.AcademiaDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((Academia.diagram.navigator.AcademiaDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new Academia.diagram.navigator.AcademiaDomainNavigatorItem(
